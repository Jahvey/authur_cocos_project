...
function ClubResult:updatacell_ren()
	...
	for i,v in ipairs(self.userlist) do
        ...
        cell:getChildByName("cell"):getChildByName("name"):setString(ComHelpFuc.getStrWithLength(v.name,7))
...
function ClubResult:updatacell_ju()
	...
	for i,v in ipairs(self.list4) do
        ...
        cell:getChildByName("cell"):getChildByName("name"):setString(ComHelpFuc.getStrWithLength(v.table.best_name or "",7))
