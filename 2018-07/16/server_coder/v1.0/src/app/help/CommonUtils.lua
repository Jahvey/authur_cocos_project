...
function CommonUtils.sendbyArgs(usertab )
 -- body
    local  userdata = {}
    userdata.uid=LocalData_instance.uid

    userdata.chip=LocalData_instance.chips

    userdata.status=1

    userdata.time=os.time()

    userdata.version=CLIENT_VERSION..'.'..CONFIG_REC_VERSION
    -- if usertab.uid then
    --     userdata.uid=usertab.uid
    -- else
    --     print("uid 错误.....")
    --     return nil
    -- end
    ...
    -- if usertab.time then
    --     userdata.time=usertab.time
    -- else
    --     print("time 错误.....")
    --     userdata.time=nil
    --     --return nil
    ...
    -- if usertab.version then
    --     userdata.version=usertab.version
    -- else
    --     print("version 错误.....")
    --     userdata.version=nil
    --     --return nil
    -- end

    -- if usertab.status then
    --     userdata.status=usertab.status
    -- else
    --     print("status 错误.....")
    --     userdata.status=nil
    --     --return nil
    -- end
    -- if usertab.chip then
    --     userdata.chip=usertab.chip
    -- else
    --     print("chip 错误.....")
    --     userdata.chip=nil
    --     --return nil
    -- end
    if usertab.json then
        userdata.json=usertab.json
    else
        print("json 错误.....")
        userdata.json=nil
        --return nil
...
function CommonUtils.sends( usertab )
    local  result = CommonUtils.sendbyArgs(usertab )
    printTable(result, "sjp3")
    result=cjson.encode(result)

    -- body
    ComHttp.httpPOST(ComHttp.URL.USERHINT,{data= result},function(msg) 
        printTable(msg, "sjp3")
