...
function ShopView:initView()
	...
	if SHENHEBAO then
		...
		self.mainLayer:getChildByName("Image_1"):setVisible(false)
		self.mainLayer:getChildByName("wechatlabel"):setVisible(false)
		self.mainLayer:getChildByName("copybtn"):setVisible(false)
	end
