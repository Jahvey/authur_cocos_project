...
function TableFactory.create(tableClass, actionClass)
    ...
    function TableRight:refreshHandTile()
        ...
        --putouttile = {17,17,17,17,17,17,17,17,17,17,17,17,17,17}
        handtile = ComHelpFuc.sortOtherHandTile(handtile)
        
        -- print("TableRight........handtile = ",handtile)
        -- print("TableRight..........#handtile = ",#handtile)
        -- printTable(handtile,"xp")
        ...
        for i,v in ipairs(handtile) do
            ...
            card:setScale(scale)
            card:setPosition(cc.p(width-(4+((i-1)%11)*38*scale+38*scale/2),math.floor(((i-1)/11))*40+42*scale/2 + 4  ))
