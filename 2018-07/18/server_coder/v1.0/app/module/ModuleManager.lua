...
loadModule("app.ui.game_MJ.game_base.test")
loadModule("app.ui.activity.worldcup")
--loadModule("app.ui.activity.novicegiftpackage")
loadModule("app.ui.bag")