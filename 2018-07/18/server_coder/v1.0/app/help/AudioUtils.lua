...
function AudioUtils.playVoice(name,sex,loop)
	...
	if sex == 0 then
		...
		local num1 = string.gsub(str, "/hp/", "/_hp/")
		local num2 = string.gsub(str, "/mj/", "/_mj/")
		local num3 = string.gsub(str, "/fjsdr/", "/_fjsdr/")
		local num4 = string.gsub(str, "/sjhp/", "/_sjhp/")
		local num5 = string.gsub(str, "/tcgzp/", "/_tcgzp/")
		if num1 or num2 or num3 or num4 or num5 then
			audio.playSound(str, loop)
		end
	else
