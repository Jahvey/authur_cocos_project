...
function PlayInfoViewforgame:initView()
	...
	if self.data then
		...
		local _headicon  = require("app.ui.common.HeadIcon").new(self.headicon,self.data.role_picture_url).headicon
		...
		local _headicon  = require("app.ui.common.HeadIcon").new(self.headicon,LocalData_instance:getPic()).headicon
	  	local size =  _headicon:getContentSize()
        _headicon:setScaleX(90/size.width)
        _headicon:setScaleY(90/size.height)
	end	
