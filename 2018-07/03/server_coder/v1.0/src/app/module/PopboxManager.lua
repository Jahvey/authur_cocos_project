...
local POPBOX = {
	...
	luckDrawMsgNodeView = {class = require "app.ui.popbox.luckDrawMsgNodeView"},
	mainHallNodeView = {class = require "app.ui.popbox.mainHallNodeView"},
	fangkaNodeView = {class = require "app.ui.popbox.fangkaNodeView"},
	myshowNodeView = {class = require "app.ui.popbox.myshowNodeView1"},
	myshowView1 = {class = require "app.ui.popbox.myshowView1"},
	-- 进入房间
