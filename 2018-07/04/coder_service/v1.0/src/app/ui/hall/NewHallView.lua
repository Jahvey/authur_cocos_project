...
function HallView:initView()
	...
	--udf
	--self:PopSceneNode(self.mainLayer)
...
-- function HallView:PopSceneNode(main_layer)
-- 	-- body
-- 	self.luckdraw=main_layer:getChildByName("Button_choujiang")
-- 		WidgetUtils.addClickEvent(self.luckdraw, function( )
-- 		print("点击luckdraw successful!!")
...
function HallView:initMidNode()
	...
	self.luckdraw=self.midNode:getChildByName("Button_choujiang")
	WidgetUtils.addClickEvent(self.luckdraw,function (  )
		LaypopManger_instance:PopBox("mainHallNodeView")
	end)
