...
function mainHallNodeView:initView()
    ...
    local arrthings={
            [1]={radian=15,prize="iphonex"},
            [2]={radian=45,prize="房卡五张"},
            [3]={radian=75,prize="红包88元"},
            [4]={radian=105,prize="房卡100张"},
            [5]={radian=135,prize="红包1元"},
            [6]={radian=165,prize="充电宝"},
            [7]={radian=195,prize="房卡20张"},
            [8]={radian=225,prize="红包5元"},
            [9]={radian=255,prize="房卡2张"},
            [10]={radian=285,prize="红包188元"},
            [11]={radian=315,prize="房卡10张"},
            [12]={radian=345,prize="iphonex"}
    }
        ...
        return
            ...
            ComHttp.httpPOST(ComHttp.URL.WHEELGETPRIZE,{uid=LocalData_instance.uid},function(msg)
                ...
                self.award:setRotation(0)
                 ...
                 self.wheels:runAction(
                    cc.Sequence:create(cc.EaseExponentialInOut:create(
                        cc.RotateBy:create(2,360*5+arrthings[msg.ord].radian)),cc.CallFunc:create(function()
                    LaypopManger_instance:PopBox("PromptBoxView",1,{tipstr = "恭喜您获得"..arrthings[msg.ord].prize})
                    end)))
                    self.award:runAction(cc.Sequence:create(
                        cc.EaseExponentialInOut:create(cc.RotateBy:create(2,360*5+arrthings[msg.ord].radian)),
