...
function BaseTable:showZhuangAction(func,_pos,hidenAnimation)
    ...
    if _pos  then
        if self.gamescene:getTableConf().ttype == HPGAMETYPE.YSGSDR then
            AudioUtils.playVoice("action_tiao2", self.gamescene:getSexByIndex(self:getTableIndex()))
        else
            AudioUtils.playVoice("action_jiezhuang", self.gamescene:getSexByIndex(self:getTableIndex()))
        end
    else
        AudioUtils.playVoice("action_dangzhuang", self.gamescene:getSexByIndex(self:getTableIndex()))
    end
end

function BaseTable:setIsShowHuaZhuang(isShow)
    if isShow then
        AudioUtils.playVoice("action_huazhuang", self.gamescene:getSexByIndex(self:getTableIndex()))
    end
...
function BaseTable:chiPaiAction(data, hidenAnimation)
    ...
    AudioUtils.playVoice("action_di", self.gamescene:getSexByIndex(self:getTableIndex()))
...
function BaseTable:pengPaiAction(data, hidenAnimation)
    ...
    AudioUtils.playVoice("action_peng", self.gamescene:getSexByIndex(self:getTableIndex()))
...
function BaseTable:weiPaiAction(data, hidenAnimation)
    ...
    AudioUtils.playVoice("action_shao", self.gamescene:getSexByIndex(self:getTableIndex()))
...
function BaseTable:dengPaiAction(data, hidenAnimation)
    ...
    AudioUtils.playVoice("action_deng", self.gamescene:getSexByIndex(self:getTableIndex()))
...
function BaseTable:fanPaiAction(data, hidenAnimation)
    ...
    runAnimation(cardNode, card_bei, function()
        ...
        -- cardNode:runAction(cc.Sequence:create(cc.DelayTime:create(0.3),cc.CallFunc:create( function()
...
function BaseTable:tuoPaiAction(data,hidenAnimation)
    ...
    AudioUtils.playVoice("action_tuo",self.gamescene:getSexByIndex(self:getTableIndex()))
